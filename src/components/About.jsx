    ...
    return(
        <div className="p-3 flex justify-evenly items-center max-lg:flex max-lg:flex-wrap max-lg:mb-8">
            ...
            <div className="p-3 border border-[#fb560730] rounded-lg max-lg:mt-8">
                ...
                <p className="w-120 text-md mb-5 max-lg:w-100">I’m a front-end developer focused on building modern, responsive, and conversion-driven interfaces. <span className="text-[#fb5607]">Skilled in HTML, CSS, JavaScript, React, Tailwind, and Bootstrap.</span> I deliver clean, scalable, and user-friendly solutions that blend design and performance.</p>
