        ...
        <main>
            <div className="p-3 flex justify-evenly items-center max-lg:flex max-lg:flex-wrap max-lg:mb-8">
                <motion.div className="max-lg:mb-6 max-lg:mt-6" initial={{ y:+200, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1.5, ease:"easeIn" }}>
                    ...
                    <div className="mt-3">
                        <motion.button whileHover={{ scale: 1.1 }} className="bg-[#fb560750] p-2 mr-5 hover:bg-transparent border border-[#fb5607]">Got a project?</motion.button>
                        <motion.button whileHover={{ scale: 1.1 }} className="border border-[#fb560770] p-2 hover:bg-[#fb5607]">Contact Me</motion.button>
                    </div>
                </motion.div>
                <div>
